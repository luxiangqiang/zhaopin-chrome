  ...
  <div class="contianer">
      ...
      <el-row class="mgb">
        <el-col :span="7">
          ...
          <el-select v-model="query.status" placeholder="请选择招聘状态">
            <el-option v-for="item in recruitmentStatusOptions" :key="item.value + 'company'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-col>
        <el-col :span="7">
          ...
          <el-input class="input-item" placeholder="请输入职位" v-model="query.job" clearable>
          </el-input>
        </el-col>
        <el-col :span="7">
          <span class="filter-text">地区：</span>
          <el-input class="input-item" placeholder="请输入职位" v-model="query.city" clearable>
          </el-input>
        </el-col>
      </el-row>
      <el-row class="row">
        <el-col :span="7">
          ...
          <el-select v-model="query.opened" class="interview-room-status" placeholder="请选择面试间状态">
            <el-option v-for="item in interviewRoomStatusOptions" :key="item.value + 'status'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-col>
        <el-col :span="7">
          ...
          <el-select v-model="query.company" multiple filterable collapse-tags placeholder="请选择公司">
            <el-option v-for="item in companyOptions" :key="item.value + 'company'" :label="item.label"
              :value="item.value">
            </el-option>
          </el-select>
        </el-col>
    ...
    <section>
      <el-table v-loading="loading" class="table" :data="tableData" stripe border height="300">
        ...
        <el-table-column v-for="item of jobColumns" :prop="item.prop" :label="item.label" :width="item.width" />
      </el-table>
      <el-pagination 
        class="pagination"
        background 
