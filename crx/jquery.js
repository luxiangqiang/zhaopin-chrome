...
!function(a, b) {
  typeof module == "object" && typeof module.exports == "object" ? module.exports = a.document ? b(a, true) : function(a2) {
    if (!a2.document)
      throw new Error("jQuery requires a window with a document");
    return b(a2);
  } : b(a);
}(typeof window != "undefined" ? window : globalThis, function(a, b) {
  var c = [], d = c.slice, e = c.concat, f = c.push, g = c.indexOf, h = {}, i = h.toString, j = h.hasOwnProperty, k = {}, l = a.document, m = "2.1.4", n = function(a2, b2) {
  ...
  n.fn = n.prototype = { jquery: m, constructor: n, selector: "", length: 0, toArray: function() {
    ...
    return a2 != null ? 0 > a2 ? this[a2 + this.length] : this[a2] : d.call(this);
    ...
    for (typeof g2 == "boolean" && (j2 = g2, g2 = arguments[h2] || {}, h2++), typeof g2 == "object" || n.isFunction(g2) || (g2 = {}), h2 === i2 && (g2 = this, h2--); i2 > h2; h2++)
      if ((a2 = arguments[h2]) != null)
        for (b2 in a2)
          c2 = g2[b2], d2 = a2[b2], g2 !== d2 && (j2 && d2 && (n.isPlainObject(d2) || (e2 = n.isArray(d2))) ? (e2 ? (e2 = false, f2 = c2 && n.isArray(c2) ? c2 : []) : f2 = c2 && n.isPlainObject(c2) ? c2 : {}, g2[b2] = n.extend(j2, f2, d2)) : d2 !== void 0 && (g2[b2] = d2));
    return g2;
    ...
    return n.type(a2) !== "object" || a2.nodeType || n.isWindow(a2) ? false : a2.constructor && !j.call(a2.constructor.prototype, "isPrototypeOf") ? false : true;
    ...
    return a2 == null ? a2 + "" : typeof a2 == "object" || typeof a2 == "function" ? h[i.call(a2)] || "object" : typeof a2;
  }, globalEval: function(a2) {
    var b2, c2 = eval;
    a2 = n.trim(a2), a2 && (a2.indexOf("use strict") === 1 ? (b2 = l.createElement("script"), b2.text = a2, l.head.appendChild(b2).parentNode.removeChild(b2)) : c2(a2));
    ...
    if (c2) {
      if (g2) {
        for (; f2 > e2; e2++)
          if (d2 = b2.apply(a2[e2], c2), d2 === false)
            break;
      } else
        for (e2 in a2)
          if (d2 = b2.apply(a2[e2], c2), d2 === false)
      ...
      for (; f2 > e2; e2++)
        if (d2 = b2.call(a2[e2], e2, a2[e2]), d2 === false)
          break;
    } else
      for (e2 in a2)
        if (d2 = b2.call(a2[e2], e2, a2[e2]), d2 === false)
    ...
    var c2 = b2 || [];
    return a2 != null && (s(Object(a2)) ? n.merge(c2, typeof a2 == "string" ? [a2] : a2) : f.call(c2, a2)), c2;
  }, inArray: function(a2, b2, c2) {
    return b2 == null ? -1 : g.call(b2, a2, c2);
  }, merge: function(a2, b2) {
    for (var c2 = +b2.length, d2 = 0, e2 = a2.length; c2 > d2; d2++)
      a2[e2++] = b2[d2];
    ...
    if (h2)
      for (; g2 > f2; f2++)
        d2 = b2(a2[f2], f2, c2), d2 != null && i2.push(d2);
    else
      for (f2 in a2)
        d2 = b2(a2[f2], f2, c2), d2 != null && i2.push(d2);
    return e.apply([], i2);
    ...
    var c2, e2, f2;
    return typeof b2 == "string" && (c2 = a2[b2], b2 = a2, a2 = c2), n.isFunction(a2) ? (e2 = d.call(arguments, 2), f2 = function() {
  ...
  function s(a2) {
    var b2 = "length" in a2 && a2.length, c2 = n.type(a2);
    return c2 === "function" || n.isWindow(a2) ? false : a2.nodeType === 1 && b2 ? true : c2 === "array" || b2 === 0 || typeof b2 == "number" && b2 > 0 && b2 - 1 in a2;
  }
  var t = function(a2) {
    var b2, c2, d2, e2, f2, g2, h2, i2, j2, k2, l2, m2, n2, o2, p2, q2, r2, s2, t2, u2 = "sizzle" + 1 * new Date(), v2 = a2.document, w2 = 0, x2 = 0, y2 = ha2(), z2 = ha2(), A2 = ha2(), B2 = function(a3, b3) {
    ...
    function ga2(a3, b3, d3, e3) {
      ...
      if ((b3 ? b3.ownerDocument || b3 : v2) !== n2 && m2(b3), b3 = b3 || n2, d3 = d3 || [], k3 = b3.nodeType, typeof a3 != "string" || !a3 || k3 !== 1 && k3 !== 9 && k3 !== 11)
        return d3;
      if (!e3 && p2) {
        if (k3 !== 11 && (f3 = _2.exec(a3)))
          if (j3 = f3[1]) {
            if (k3 === 9) {
              if (h3 = b3.getElementById(j3), !h3 || !h3.parentNode)
                return d3;
              if (h3.id === j3)
                return d3.push(h3), d3;
            } else if (b3.ownerDocument && (h3 = b3.ownerDocument.getElementById(j3)) && t2(b3, h3) && h3.id === j3)
              return d3.push(h3), d3;
          } else {
            if (f3[2])
              return H2.apply(d3, b3.getElementsByTagName(a3)), d3;
            if ((j3 = f3[3]) && c2.getElementsByClassName)
              return H2.apply(d3, b3.getElementsByClassName(j3)), d3;
          }
        if (c2.qsa && (!q2 || !q2.test(a3))) {
          if (s3 = r3 = u2, w3 = b3, x3 = k3 !== 1 && a3, k3 === 1 && b3.nodeName.toLowerCase() !== "object") {
            o3 = g2(a3), (r3 = b3.getAttribute("id")) ? s3 = r3.replace(ba2, "\\$&") : b3.setAttribute("id", s3), s3 = "[id='" + s3 + "'] ", l3 = o3.length;
            while (l3--)
              o3[l3] = s3 + ra2(o3[l3]);
            w3 = aa2.test(a3) && pa2(b3.parentNode) || b3, x3 = o3.join(",");
          }
          if (x3)
            try {
    ...
    function la2(a3, b3) {
      var c3 = b3 && a3, d3 = c3 && a3.nodeType === 1 && b3.nodeType === 1 && (~b3.sourceIndex || C2) - (~a3.sourceIndex || C2);
      if (d3)
        return d3;
      if (c3) {
    ...
    function pa2(a3) {
      return a3 && typeof a3.getElementsByTagName != "undefined" && a3;
    }
    c2 = ga2.support = {}, f2 = ga2.isXML = function(a3) {
      ...
      return g3 !== n2 && g3.nodeType === 9 && g3.documentElement ? (n2 = g3, o2 = g3.documentElement, e3 = g3.defaultView, e3 && e3 !== e3.top && (e3.addEventListener ? e3.addEventListener("unload", ea2, false) : e3.attachEvent && e3.attachEvent("onunload", ea2)), p2 = !f2(g3), c2.attributes = ja2(function(a4) {
        ...
        var b4 = a4.replace(ca2, da2);
        return function(a5) {
          var c3 = typeof a5.getAttributeNode != "undefined" && a5.getAttributeNode("id");
          return c3 && c3.value === b4;
        };
      }), d2.find.TAG = c2.getElementsByTagName ? function(a4, b4) {
        return typeof b4.getElementsByTagName != "undefined" ? b4.getElementsByTagName(a4) : c2.qsa ? b4.querySelectorAll(a4) : void 0;
      } : function(a4, b4) {
      ...
      }, r2 = [], q2 = [], (c2.qsa = $2.test(g3.querySelectorAll)) && (ja2(function(a4) {
      ...
      })), (c2.matchesSelector = $2.test(s2 = o2.matches || o2.webkitMatchesSelector || o2.mozMatchesSelector || o2.oMatchesSelector || o2.msMatchesSelector)) && ja2(function(a4) {
        ...
        var c3 = a4.nodeType === 9 ? a4.documentElement : a4, d3 = b4 && b4.parentNode;
        ...
        if (!e4 || !f3)
          return a4 === g3 ? -1 : b4 === g3 ? 1 : e4 ? -1 : f3 ? 1 : k2 ? J2(k2, a4) - J2(k2, b4) : 0;
        if (e4 === f3)
          return la2(a4, b4);
        c3 = a4;
        ...
        while (h3[d3] === i3[d3])
          d3++;
        return d3 ? la2(h3[d3], i3[d3]) : h3[d3] === v2 ? -1 : i3[d3] === v2 ? 1 : 0;
      }, g3) : n2;
    }, ga2.matches = function(a3, b3) {
      return ga2(a3, null, null, b3);
    }, ga2.matchesSelector = function(a3, b3) {
      if ((a3.ownerDocument || a3) !== n2 && m2(a3), b3 = b3.replace(U2, "='$1']"), !(!c2.matchesSelector || !p2 || r2 && r2.test(b3) || q2 && q2.test(b3)))
        try {
      ...
      if (f3) {
        ...
        while (b3 = a3[d3++])
          c3 += e2(b3);
      return c3;
    }, d2 = ga2.selectors = { cacheLength: 50, createPseudo: ia2, match: X2, attrHandle: {}, find: {}, relative: { ">": { dir: "parentNode", first: true }, " ": { dir: "parentNode" }, "+": { dir: "previousSibling", first: true }, "~": { dir: "previousSibling" } }, preFilter: { ATTR: function(a3) {
      return a3[1] = a3[1].replace(ca2, da2), a3[3] = (a3[3] || a3[4] || a3[5] || "").replace(ca2, da2), a3[2] === "~=" && (a3[3] = " " + a3[3] + " "), a3.slice(0, 4);
    }, CHILD: function(a3) {
      return a3[1] = a3[1].toLowerCase(), a3[1].slice(0, 3) === "nth" ? (a3[3] || ga2.error(a3[0]), a3[4] = +(a3[4] ? a3[5] + (a3[6] || 1) : 2 * (a3[3] === "even" || a3[3] === "odd")), a3[5] = +(a3[7] + a3[8] || a3[3] === "odd")) : a3[3] && ga2.error(a3[0]), a3;
    }, PSEUDO: function(a3) {
      var b3, c3 = !a3[6] && a3[2];
      ...
      var b3 = a3.replace(ca2, da2).toLowerCase();
      return a3 === "*" ? function() {
        return true;
      } : function(a4) {
      ...
      return b3 || (b3 = new RegExp("(^|" + L2 + ")" + a3 + "(" + L2 + "|$)")) && y2(a3, function(a4) {
        return b3.test(typeof a4.className == "string" && a4.className || typeof a4.getAttribute != "undefined" && a4.getAttribute("class") || "");
      });
    }, ATTR: function(a3, b3, c3) {
      return function(d3) {
        var e3 = ga2.attr(d3, a3);
        return e3 == null ? b3 === "!=" : b3 ? (e3 += "", b3 === "=" ? e3 === c3 : b3 === "!=" ? e3 !== c3 : b3 === "^=" ? c3 && e3.indexOf(c3) === 0 : b3 === "*=" ? c3 && e3.indexOf(c3) > -1 : b3 === "$=" ? c3 && e3.slice(-c3.length) === c3 : b3 === "~=" ? (" " + e3.replace(Q2, " ") + " ").indexOf(c3) > -1 : b3 === "|=" ? e3 === c3 || e3.slice(0, c3.length + 1) === c3 + "-" : false) : true;
      };
    }, CHILD: function(a3, b3, c3, d3, e3) {
      var f3 = a3.slice(0, 3) !== "nth", g3 = a3.slice(-4) !== "last", h3 = b3 === "of-type";
        ...
        if (q3) {
          if (f3) {
            while (p3) {
              l3 = b4;
              while (l3 = l3[p3])
                if (h3 ? l3.nodeName.toLowerCase() === r3 : l3.nodeType === 1)
                  return false;
          ...
          if (o3 = [g3 ? q3.firstChild : q3.lastChild], g3 && s3) {
            ...
            while (l3 = ++n3 && l3 && l3[p3] || (m3 = n3 = 0) || o3.pop())
              if (l3.nodeType === 1 && ++m3 && l3 === b4) {
                k3[a3] = [w2, n3, m3];
                break;
              }
          } else if (s3 && (j3 = (b4[u2] || (b4[u2] = {}))[a3]) && j3[0] === w2)
            m3 = j3[1];
          else
            while (l3 = ++n3 && l3 && l3[p3] || (m3 = n3 = 0) || o3.pop())
              if ((h3 ? l3.nodeName.toLowerCase() === r3 : l3.nodeType === 1) && ++m3 && (s3 && ((l3[u2] || (l3[u2] = {}))[a3] = [w2, m3]), l3 === b4))
                break;
      ...
      return a3 = a3.replace(ca2, da2), function(b3) {
        return (b3.textContent || b3.innerText || e2(b3)).indexOf(a3) > -1;
      };
    }), lang: ia2(function(a3) {
      return W2.test(a3 || "") || ga2.error("unsupported lang: " + a3), a3 = a3.replace(ca2, da2).toLowerCase(), function(b3) {
        var c3;
        do
          if (c3 = p2 ? b3.lang : b3.getAttribute("xml:lang") || b3.getAttribute("lang"))
            return c3 = c3.toLowerCase(), c3 === a3 || c3.indexOf(a3 + "-") === 0;
      ...
      return [0];
    }), last: oa2(function(a3, b3) {
      return [b3 - 1];
    }), eq: oa2(function(a3, b3, c3) {
      return [0 > c3 ? c3 + b3 : c3];
    }), even: oa2(function(a3, b3) {
      for (var c3 = 0; b3 > c3; c3 += 2)
        a3.push(c3);
      return a3;
    }), odd: oa2(function(a3, b3) {
      for (var c3 = 1; b3 > c3; c3 += 2)
        a3.push(c3);
      return a3;
    }), lt: oa2(function(a3, b3, c3) {
      for (var d3 = 0 > c3 ? c3 + b3 : c3; --d3 >= 0; )
        a3.push(d3);
      return a3;
    }), gt: oa2(function(a3, b3, c3) {
    ...
    qa2.prototype = d2.filters = d2.pseudos, d2.setFilters = new qa2(), g2 = ga2.tokenize = function(a3, b3) {
      ...
      while (h3) {
        ...
        for (g3 in d2.filter)
          !(e3 = X2[g3].exec(h3)) || j3[g3] && !(e3 = j3[g3](e3)) || (c3 = e3.shift(), f3.push({ value: c3, type: g3, matches: e3 }), h3 = h3.slice(c3.length));
        if (!c3)
          break;
      }
    ...
    function sa2(a3, b3, c3) {
      var d3 = b3.dir, e3 = c3 && d3 === "parentNode", f3 = x2++;
      return b3.first ? function(b4, c4, f4) {
        ...
        if (g3) {
          ...
          while (b4 = b4[d3])
            if (b4.nodeType === 1 || e3) {
              if (i3 = b4[u2] || (b4[u2] = {}), (h3 = i3[d3]) && h3[0] === w2 && h3[1] === f3)
                return j3[2] = h3[2];
              if (i3[d3] = j3, j3[2] = a3(b4, c4, g3))
                return true;
            }
      };
    }
    ...
    function ua2(a3, b3, c3) {
      for (var d3 = 0, e3 = b3.length; e3 > d3; d3++)
        ga2(a3, b3[d3], c3);
      return c3;
    }
    function va2(a3, b3, c3, d3, e3) {
      for (var f3, g3 = [], h3 = 0, i3 = a3.length, j3 = b3 != null; i3 > h3; h3++)
        (f3 = a3[h3]) && (!c3 || c3(f3, d3, e3)) && (g3.push(f3), j3 && b3.push(h3));
      return g3;
    }
    function wa2(a3, b3, c3, d3, e3, f3) {
      return d3 && !d3[u2] && (d3 = wa2(d3)), e3 && !e3[u2] && (e3 = wa2(e3, f3)), ia2(function(f4, g3, h3, i3) {
        var j3, k3, l3, m3 = [], n3 = [], o3 = g3.length, p3 = f4 || ua2(b3 || "*", h3.nodeType ? [h3] : h3, []), q3 = !a3 || !f4 && b3 ? p3 : va2(p3, m3, a3, h3, i3), r3 = c3 ? e3 || (f4 ? a3 : o3 || d3) ? [] : g3 : q3;
        if (c3 && c3(q3, r3, h3, i3), d3) {
          j3 = va2(r3, n3), d3(j3, [], h3, i3), k3 = j3.length;
          while (k3--)
        ...
        if (f4) {
          ...
          r3 = va2(r3 === g3 ? r3.splice(o3, r3.length) : r3), e3 ? e3(null, g3, r3, i3) : H2.apply(g3, r3);
      });
    }
    function xa2(a3) {
      for (var b3, c3, e3, f3 = a3.length, g3 = d2.relative[a3[0].type], h3 = g3 || d2.relative[" "], i3 = g3 ? 1 : 0, k3 = sa2(function(a4) {
        return a4 === b3;
      }, h3, true), l3 = sa2(function(a4) {
        return J2(b3, a4) > -1;
          ...
          if (c3 = d2.filter[a3[i3].type].apply(null, a3[i3].matches), c3[u2]) {
            for (e3 = ++i3; f3 > e3; e3++)
              if (d2.relative[a3[e3].type])
                break;
            return wa2(i3 > 1 && ta2(m3), i3 > 1 && ra2(a3.slice(0, i3 - 1).concat({ value: a3[i3 - 2].type === " " ? "*" : "" })).replace(R2, "$1"), c3, e3 > i3 && xa2(a3.slice(i3, e3)), f3 > e3 && xa2(a3 = a3.slice(e3)), f3 > e3 && ra2(a3));
          }
          m3.push(c3);
        }
      return ta2(m3);
    ...
    function ya2(a3, b3) {
      var c3 = b3.length > 0, e3 = a3.length > 0, f3 = function(f4, g3, h3, i3, k3) {
        var l3, m3, o3, p3 = 0, q3 = "0", r3 = f4 && [], s3 = [], t3 = j2, u3 = f4 || e3 && d2.find.TAG("*", k3), v3 = w2 += t3 == null ? 1 : Math.random() || 0.1, x3 = u3.length;
        for (k3 && (j2 = g3 !== n2 && g3); q3 !== x3 && (l3 = u3[q3]) != null; q3++) {
          if (e3 && l3) {
            m3 = 0;
            while (o3 = a3[m3++])
              if (o3(l3, g3, h3)) {
        ...
        if (p3 += q3, c3 && q3 !== p3) {
          ...
          if (f4) {
            if (p3 > 0)
              while (q3--)
                r3[q3] || s3[q3] || (s3[q3] = F2.call(i3));
            s3 = va2(s3);
          }
          H2.apply(i3, s3), k3 && !f4 && s3.length > 0 && p3 + b3.length > 1 && ga2.uniqueSort(i3);
        }
    ...
    return h2 = ga2.compile = function(a3, b3) {
      ...
      if (!f3) {
        ...
        while (c3--)
          f3 = xa2(b3[c3]), f3[u2] ? d3.push(f3) : e3.push(f3);
        f3 = A2(a3, ya2(e3, d3)), f3.selector = a3;
      }
      return f3;
    }, i2 = ga2.select = function(a3, b3, e3, f3) {
      var i3, j3, k3, l3, m3, n3 = typeof a3 == "function" && a3, o3 = !f3 && g2(a3 = n3.selector || a3);
      if (e3 = e3 || [], o3.length === 1) {
        if (j3 = o3[0] = o3[0].slice(0), j3.length > 2 && (k3 = j3[0]).type === "ID" && c2.getById && b3.nodeType === 9 && p2 && d2.relative[j3[1].type]) {
          if (b3 = (d2.find.ID(k3.matches[0].replace(ca2, da2), b3) || [])[0], !b3)
            return e3;
        ...
        while (i3--) {
          if (k3 = j3[i3], d2.relative[l3 = k3.type])
            break;
          if ((m3 = d2.find[l3]) && (f3 = m3(k3.matches[0].replace(ca2, da2), aa2.test(j3[0].type) && pa2(b3.parentNode) || b3))) {
            if (j3.splice(i3, 1), a3 = f3.length && ra2(j3), !a3)
              return H2.apply(e3, f3), e3;
            break;
          }
        }
      }
      return (n3 || h2(a3, o3))(f3, b3, !p2, e3, aa2.test(a3) && pa2(b3.parentNode) || b3), e3;
  ...
  n.filter = function(a2, b2, c2) {
    var d2 = b2[0];
    return c2 && (a2 = ":not(" + a2 + ")"), b2.length === 1 && d2.nodeType === 1 ? n.find.matchesSelector(d2, a2) ? [d2] : [] : n.find.matches(a2, n.grep(b2, function(a3) {
    ...
    return !!x(this, typeof a2 == "string" && u.test(a2) ? n(a2) : a2 || [], false).length;
  } });
  var y, z = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, A = n.fn.init = function(a2, b2) {
    ...
    if (!a2)
      return this;
    if (typeof a2 == "string") {
      if (c2 = a2[0] === "<" && a2[a2.length - 1] === ">" && a2.length >= 3 ? [null, a2, null] : z.exec(a2), !c2 || !c2[1] && b2)
        return !b2 || b2.jquery ? (b2 || y).find(a2) : this.constructor(b2).find(a2);
      if (c2[1]) {
        if (b2 = b2 instanceof n ? b2[0] : b2, n.merge(this, n.parseHTML(c2[1], b2 && b2.nodeType ? b2.ownerDocument || b2 : l, true)), v.test(c2[1]) && n.isPlainObject(b2))
          for (c2 in b2)
            n.isFunction(this[c2]) ? this[c2](b2[c2]) : this.attr(c2, b2[c2]);
        return this;
      }
      return d2 = l.getElementById(c2[2]), d2 && d2.parentNode && (this.length = 1, this[0] = d2), this.context = l, this.selector = a2, this;
    }
    return a2.nodeType ? (this.context = this[0] = a2, this.length = 1, this) : n.isFunction(a2) ? typeof y.ready != "undefined" ? y.ready(a2) : a2(n) : (a2.selector !== void 0 && (this.selector = a2.selector, this.context = a2.context), n.makeArray(a2, this));
  };
  A.prototype = n.fn, y = n(l);
  var B = /^(?:parents|prev(?:Until|All))/, C = { children: true, contents: true, next: true, prev: true };
  n.extend({ dir: function(a2, b2, c2) {
    var d2 = [], e2 = c2 !== void 0;
    while ((a2 = a2[b2]) && a2.nodeType !== 9)
      if (a2.nodeType === 1) {
        if (e2 && n(a2).is(c2))
          break;
        d2.push(a2);
    ...
    return this.filter(function() {
      for (var a3 = 0; c2 > a3; a3++)
        if (n.contains(this, b2[a3]))
          return true;
    });
  }, closest: function(a2, b2) {
    for (var c2, d2 = 0, e2 = this.length, f2 = [], g2 = u.test(a2) || typeof a2 != "string" ? n(a2, b2 || this.context) : 0; e2 > d2; d2++)
    ...
    return a2 ? typeof a2 == "string" ? g.call(n(a2), this[0]) : g.call(this, a2.jquery ? a2[0] : a2) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1;
  }, add: function(a2, b2) {
  ...
  n.each({ parent: function(a2) {
    ...
    n.fn[a2] = function(c2, d2) {
      ...
      return a2.slice(-5) !== "Until" && (d2 = c2), d2 && typeof d2 == "string" && (e2 = n.filter(d2, e2)), this.length > 1 && (C[a2] || n.unique(e2), B.test(a2) && e2.reverse()), this.pushStack(e2);
    };
  });
  var E = /\S+/g, F = {};
  function G(a2) {
  ...
  n.Callbacks = function(a2) {
    a2 = typeof a2 == "string" ? F[a2] || G(a2) : n.extend({}, a2);
    var b2, c2, d2, e2, f2, g2, h2 = [], i2 = !a2.once && [], j2 = function(l2) {
      for (b2 = a2.memory && l2, c2 = true, g2 = e2 || 0, e2 = 0, f2 = h2.length, d2 = true; h2 && f2 > g2; g2++)
        if (h2[g2].apply(l2[0], l2[1]) === false && a2.stopOnFalse) {
          b2 = false;
          break;
        }
      ...
      if (h2) {
        ...
        !function g3(b3) {
          n.each(b3, function(b4, c4) {
            var d3 = n.type(c4);
            d3 === "function" ? a2.unique && k2.has(c4) || h2.push(c4) : c4 && c4.length && d3 !== "string" && g3(c4);
          });
      ...
      return h2 && n.each(arguments, function(a3, b3) {
        var c3;
        while ((c3 = n.inArray(b3, h2, c3)) > -1)
          h2.splice(c3, 1), d2 && (f2 >= c3 && f2--, g2 >= c3 && g2--);
      }), this;
    }, has: function(a3) {
    ...
    var b2 = 0, c2 = d.call(arguments), e2 = c2.length, f2 = e2 !== 1 || a2 && n.isFunction(a2.promise) ? e2 : 0, g2 = f2 === 1 ? a2 : n.Deferred(), h2 = function(a3, b3, c3) {
      return function(e3) {
        b3[a3] = this, c3[a3] = arguments.length > 1 ? d.call(arguments) : e3, c3 === i2 ? g2.notifyWith(b3, c3) : --f2 || g2.resolveWith(b3, c3);
      };
    }, i2, j2, k2;
    if (e2 > 1)
      for (i2 = new Array(e2), j2 = new Array(e2), k2 = new Array(e2); e2 > b2; b2++)
        c2[b2] && n.isFunction(c2[b2].promise) ? c2[b2].promise().done(h2(b2, k2, c2)).fail(g2.reject).progress(h2(b2, j2, i2)) : --f2;
  ...
  n.ready.promise = function(b2) {
    return H || (H = n.Deferred(), l.readyState === "complete" ? setTimeout(n.ready) : (l.addEventListener("DOMContentLoaded", I, false), a.addEventListener("load", I, false))), H.promise(b2);
  }, n.ready.promise();
  var J = n.access = function(a2, b2, c2, d2, e2, f2, g2) {
    var h2 = 0, i2 = a2.length, j2 = c2 == null;
    if (n.type(c2) === "object") {
      e2 = true;
      for (h2 in c2)
        n.access(a2, b2, h2, c2[h2], true, f2, g2);
    } else if (d2 !== void 0 && (e2 = true, n.isFunction(d2) || (g2 = true), j2 && (g2 ? (b2.call(a2, d2), b2 = null) : (j2 = b2, b2 = function(a3, b3, c3) {
  ...
  n.acceptData = function(a2) {
    return a2.nodeType === 1 || a2.nodeType === 9 || !+a2.nodeType;
  };
  function K() {
  ...
  K.uid = 1, K.accepts = n.acceptData, K.prototype = { key: function(a2) {
    ...
    if (typeof b2 == "string")
      f2[b2] = c2;
    else if (n.isEmptyObject(f2))
      n.extend(this.cache[e2], b2);
    else
      for (d2 in b2)
        f2[d2] = b2[d2];
    return f2;
    ...
    return b2 === void 0 ? c2 : c2[b2];
  }, access: function(a2, b2, c2) {
    var d2;
    return b2 === void 0 || b2 && typeof b2 == "string" && c2 === void 0 ? (d2 = this.get(a2, b2), d2 !== void 0 ? d2 : this.get(a2, n.camelCase(b2))) : (this.set(a2, b2, c2), c2 !== void 0 ? c2 : b2);
  ...
  function P(a2, b2, c2) {
    ...
    if (c2 === void 0 && a2.nodeType === 1)
      if (d2 = "data-" + b2.replace(O, "-$1").toLowerCase(), c2 = a2.getAttribute(d2), typeof c2 == "string") {
        try {
          c2 = c2 === "true" ? true : c2 === "false" ? false : c2 === "null" ? null : +c2 + "" === c2 ? +c2 : N.test(c2) ? n.parseJSON(c2) : c2;
        } catch (e2) {
        }
        M.set(a2, b2, c2);
      } else
  ...
  n.extend({ hasData: function(a2) {
    ...
    if (a2 === void 0) {
      if (this.length && (e2 = M.get(f2), f2.nodeType === 1 && !L.get(f2, "hasDataAttrs"))) {
        c2 = g2.length;
        while (c2--)
          g2[c2] && (d2 = g2[c2].name, d2.indexOf("data-") === 0 && (d2 = n.camelCase(d2.slice(5)), P(f2, d2, e2[d2])));
    ...
    return typeof a2 == "object" ? this.each(function() {
      ...
      if (f2 && b3 === void 0) {
        if (c3 = M.get(f2, a2), c3 !== void 0)
          return c3;
        if (c3 = M.get(f2, d3), c3 !== void 0)
          return c3;
        if (c3 = P(f2, d3, void 0), c3 !== void 0)
          return c3;
      } else
        this.each(function() {
          var c4 = M.get(this, d3);
          M.set(this, d3, b3), a2.indexOf("-") !== -1 && c4 !== void 0 && M.set(this, a2, b3);
        });
    ...
    e2 === "inprogress" && (e2 = c2.shift(), d2--), e2 && (b2 === "fx" && c2.unshift("inprogress"), delete f2.stop, e2.call(a2, g2, f2)), !d2 && f2 && f2.empty.fire();
    ...
    var c2 = 2;
    return typeof a2 != "string" && (b2 = a2, a2 = "fx", c2--), arguments.length < c2 ? n.queue(this[0], a2) : b2 === void 0 ? this : this.each(function() {
      var c3 = n.queue(this, a2, b2);
      n._queueHooks(this, a2), a2 === "fx" && c3[0] !== "inprogress" && n.dequeue(this, a2);
    });
  }, dequeue: function(a2) {
    return this.each(function() {
      n.dequeue(this, a2);
    ...
    typeof a2 != "string" && (b2 = a2, a2 = void 0), a2 = a2 || "fx";
    while (g2--)
      c2 = L.get(f2[g2], a2 + "queueHooks"), c2 && c2.empty && (d2++, c2.empty.add(h2));
    return h2(), e2.promise(b2);
  } });
  var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, R = ["Top", "Right", "Bottom", "Left"], S = function(a2, b2) {
    return a2 = b2 || a2, n.css(a2, "display") === "none" || !n.contains(a2.ownerDocument, a2);
  }, T = /^(?:checkbox|radio)$/i;
  !function() {
  ...
  n.event = { global: {}, add: function(a2, b2, c2, d2, e2) {
    ...
    if (r2) {
      ...
      while (j2--)
        h2 = Y.exec(b2[j2]) || [], o2 = q2 = h2[1], p2 = (h2[2] || "").split(".").sort(), o2 && (l2 = n.event.special[o2] || {}, o2 = (e2 ? l2.delegateType : l2.bindType) || o2, l2 = n.event.special[o2] || {}, k2 = n.extend({ type: o2, origType: q2, data: d2, handler: c2, guid: c2.guid, selector: e2, needsContext: e2 && n.expr.match.needsContext.test(e2), namespace: p2.join(".") }, f2), (m2 = i2[o2]) || (m2 = i2[o2] = [], m2.delegateCount = 0, l2.setup && l2.setup.call(a2, d2, p2, g2) !== false || a2.addEventListener && a2.addEventListener(o2, g2, false)), l2.add && (l2.add.call(a2, k2), k2.handler.guid || (k2.handler.guid = c2.guid)), e2 ? m2.splice(m2.delegateCount++, 0, k2) : m2.push(k2), n.event.global[o2] = true);
    }
    ...
    if (r2 && (i2 = r2.events)) {
      b2 = (b2 || "").match(E) || [""], j2 = b2.length;
      while (j2--)
        if (h2 = Y.exec(b2[j2]) || [], o2 = q2 = h2[1], p2 = (h2[2] || "").split(".").sort(), o2) {
          l2 = n.event.special[o2] || {}, o2 = (d2 ? l2.delegateType : l2.bindType) || o2, m2 = i2[o2] || [], h2 = h2[2] && new RegExp("(^|\\.)" + p2.join("\\.(?:.*\\.|)") + "(\\.|$)"), g2 = f2 = m2.length;
          while (f2--)
            k2 = m2[f2], !e2 && q2 !== k2.origType || c2 && c2.guid !== k2.guid || h2 && !h2.test(k2.namespace) || d2 && d2 !== k2.selector && (d2 !== "**" || !k2.selector) || (m2.splice(f2, 1), k2.selector && m2.delegateCount--, l2.remove && l2.remove.call(a2, k2));
    ...
    if (g2 = h2 = d2 = d2 || l, d2.nodeType !== 3 && d2.nodeType !== 8 && !X.test(q2 + n.event.triggered) && (q2.indexOf(".") >= 0 && (r2 = q2.split("."), q2 = r2.shift(), r2.sort()), k2 = q2.indexOf(":") < 0 && "on" + q2, b2 = b2[n.expando] ? b2 : new n.Event(q2, typeof b2 == "object" && b2), b2.isTrigger = e2 ? 2 : 3, b2.namespace = r2.join("."), b2.namespace_re = b2.namespace ? new RegExp("(^|\\.)" + r2.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b2.result = void 0, b2.target || (b2.target = d2), c2 = c2 == null ? [b2] : n.makeArray(c2, [b2]), o2 = n.event.special[q2] || {}, e2 || !o2.trigger || o2.trigger.apply(d2, c2) !== false)) {
      if (!e2 && !o2.noBubble && !n.isWindow(d2)) {
        for (i2 = o2.delegateType || q2, X.test(i2 + q2) || (g2 = g2.parentNode); g2; g2 = g2.parentNode)
          p2.push(g2), h2 = g2;
        h2 === (d2.ownerDocument || l) && p2.push(h2.defaultView || h2.parentWindow || a);
      }
      f2 = 0;
      while ((g2 = p2[f2++]) && !b2.isPropagationStopped())
        b2.type = f2 > 1 ? i2 : o2.bindType || q2, m2 = (L.get(g2, "events") || {})[b2.type] && L.get(g2, "handle"), m2 && m2.apply(g2, c2), m2 = k2 && g2[k2], m2 && m2.apply && n.acceptData(g2) && (b2.result = m2.apply(g2, c2), b2.result === false && b2.preventDefault());
    ...
    if (i2[0] = a2, a2.delegateTarget = this, !k2.preDispatch || k2.preDispatch.call(this, a2) !== false) {
      ...
      while ((f2 = h2[b2++]) && !a2.isPropagationStopped()) {
        ...
        while ((g2 = f2.handlers[c2++]) && !a2.isImmediatePropagationStopped())
          (!a2.namespace_re || a2.namespace_re.test(g2.namespace)) && (a2.handleObj = g2, a2.data = g2.data, e2 = ((n.event.special[g2.origType] || {}).handle || g2.handler).apply(f2.elem, i2), e2 !== void 0 && (a2.result = e2) === false && (a2.preventDefault(), a2.stopPropagation()));
      }
    ...
    if (h2 && i2.nodeType && (!a2.button || a2.type !== "click")) {
      for (; i2 !== this; i2 = i2.parentNode || this)
        if (i2.disabled !== true || a2.type !== "click") {
          for (d2 = [], c2 = 0; h2 > c2; c2++)
            f2 = b2[c2], e2 = f2.selector + " ", d2[e2] === void 0 && (d2[e2] = f2.needsContext ? n(e2, this).index(i2) >= 0 : n.find(e2, this, null, [i2]).length), d2[e2] && d2.push(f2);
    ...
    return a2.which == null && (a2.which = b2.charCode != null ? b2.charCode : b2.keyCode), a2;
    ...
    return a2.pageX == null && b2.clientX != null && (c2 = a2.target.ownerDocument || l, d2 = c2.documentElement, e2 = c2.body, a2.pageX = b2.clientX + (d2 && d2.scrollLeft || e2 && e2.scrollLeft || 0) - (d2 && d2.clientLeft || e2 && e2.clientLeft || 0), a2.pageY = b2.clientY + (d2 && d2.scrollTop || e2 && e2.scrollTop || 0) - (d2 && d2.clientTop || e2 && e2.clientTop || 0)), a2.which || f2 === void 0 || (a2.which = 1 & f2 ? 1 : 2 & f2 ? 3 : 4 & f2 ? 2 : 0), a2;
  } }, fix: function(a2) {
    if (a2[n.expando])
      return a2;
    ...
    while (b2--)
      c2 = d2[b2], a2[c2] = f2[c2];
    return a2.target || (a2.target = l), a2.target.nodeType === 3 && (a2.target = a2.target.parentNode), g2.filter ? g2.filter(a2, f2) : a2;
    ...
    return this.type === "checkbox" && this.click && n.nodeName(this, "input") ? (this.click(), false) : void 0;
    ...
    return this instanceof n.Event ? (a2 && a2.type ? (this.originalEvent = a2, this.type = a2.type, this.isDefaultPrevented = a2.defaultPrevented || a2.defaultPrevented === void 0 && a2.returnValue === false ? Z : $) : this.type = a2, b2 && n.extend(this, b2), this.timeStamp = a2 && a2.timeStamp || n.now(), void (this[n.expando] = true)) : new n.Event(a2, b2);
    ...
    var f2, g2;
    if (typeof a2 == "object") {
      typeof b2 != "string" && (c2 = c2 || b2, b2 = void 0);
      for (g2 in a2)
        this.on(g2, b2, c2, a2[g2], e2);
      return this;
    }
    if (c2 == null && d2 == null ? (d2 = b2, c2 = b2 = void 0) : d2 == null && (typeof b2 == "string" ? (d2 = c2, c2 = void 0) : (d2 = c2, c2 = b2, b2 = void 0)), d2 === false)
      d2 = $;
    else if (!d2)
      return this;
    return e2 === 1 && (f2 = d2, d2 = function(a3) {
    ...
    return (b2 === false || typeof b2 == "function") && (c2 = b2, b2 = void 0), c2 === false && (c2 = $), this.each(function() {
  ...
  function ka(a2) {
    return a2.type = (a2.getAttribute("type") !== null) + "/" + a2.type, a2;
  }
  function la(a2) {
    var b2 = ga.exec(a2.type);
    return b2 ? a2.type = b2[1] : a2.removeAttribute("type"), a2;
  }
  function ma(a2, b2) {
    for (var c2 = 0, d2 = a2.length; d2 > c2; c2++)
      L.set(a2[c2], "globalEval", !b2 || L.get(b2[c2], "globalEval"));
  }
  function na(a2, b2) {
    ...
    if (b2.nodeType === 1) {
      if (L.hasData(a2) && (f2 = L.access(a2), g2 = L.set(b2, f2), j2 = f2.events)) {
        ...
        for (e2 in j2)
          for (c2 = 0, d2 = j2[e2].length; d2 > c2; c2++)
            n.event.add(b2, e2, j2[e2][c2]);
      }
  ...
  function oa(a2, b2) {
    ...
    return b2 === void 0 || b2 && n.nodeName(a2, b2) ? n.merge([a2], c2) : c2;
  }
  function pa(a2, b2) {
    var c2 = b2.nodeName.toLowerCase();
    c2 === "input" && T.test(a2.type) ? b2.checked = a2.checked : (c2 === "input" || c2 === "textarea") && (b2.defaultValue = a2.defaultValue);
  }
  n.extend({ clone: function(a2, b2, c2) {
    var d2, e2, f2, g2, h2 = a2.cloneNode(true), i2 = n.contains(a2.ownerDocument, a2);
    if (!(k.noCloneChecked || a2.nodeType !== 1 && a2.nodeType !== 11 || n.isXMLDoc(a2)))
      for (g2 = oa(h2), f2 = oa(a2), d2 = 0, e2 = f2.length; e2 > d2; d2++)
        pa(f2[d2], g2[d2]);
    if (b2)
      if (c2)
        for (f2 = f2 || oa(a2), g2 = g2 || oa(h2), d2 = 0, e2 = f2.length; e2 > d2; d2++)
          na(f2[d2], g2[d2]);
      else
        na(a2, h2);
    return g2 = oa(h2, "script"), g2.length > 0 && ma(g2, !i2 && oa(a2, "script")), h2;
  }, buildFragment: function(a2, b2, c2, d2) {
    for (var e2, f2, g2, h2, i2, j2, k2 = b2.createDocumentFragment(), l2 = [], m2 = 0, o2 = a2.length; o2 > m2; m2++)
      if (e2 = a2[m2], e2 || e2 === 0)
        if (n.type(e2) === "object")
          n.merge(l2, e2.nodeType ? [e2] : e2);
        else if (ca.test(e2)) {
          f2 = f2 || k2.appendChild(b2.createElement("div")), g2 = (ba.exec(e2) || ["", ""])[1].toLowerCase(), h2 = ia[g2] || ia._default, f2.innerHTML = h2[1] + e2.replace(aa, "<$1></$2>") + h2[2], j2 = h2[0];
          while (j2--)
            f2 = f2.lastChild;
          n.merge(l2, f2.childNodes), f2 = k2.firstChild, f2.textContent = "";
        } else
          l2.push(b2.createTextNode(e2));
    k2.textContent = "", m2 = 0;
    while (e2 = l2[m2++])
      if ((!d2 || n.inArray(e2, d2) === -1) && (i2 = n.contains(e2.ownerDocument, e2), f2 = oa(k2.appendChild(e2), "script"), i2 && ma(f2), c2)) {
        j2 = 0;
        while (e2 = f2[j2++])
          fa.test(e2.type || "") && c2.push(e2);
      }
    return k2;
  }, cleanData: function(a2) {
    for (var b2, c2, d2, e2, f2 = n.event.special, g2 = 0; (c2 = a2[g2]) !== void 0; g2++) {
      if (n.acceptData(c2) && (e2 = c2[L.expando], e2 && (b2 = L.cache[e2]))) {
        if (b2.events)
          for (d2 in b2.events)
            f2[d2] ? n.event.remove(c2, d2) : n.removeEvent(c2, d2, b2.handle);
    ...
    return J(this, function(a3) {
      return a3 === void 0 ? n.text(this) : this.empty().each(function() {
        (this.nodeType === 1 || this.nodeType === 11 || this.nodeType === 9) && (this.textContent = a3);
      });
    ...
    for (var c2, d2 = a2 ? n.filter(a2, this) : this, e2 = 0; (c2 = d2[e2]) != null; e2++)
      b2 || c2.nodeType !== 1 || n.cleanData(oa(c2)), c2.parentNode && (b2 && n.contains(c2.ownerDocument, c2) && ma(oa(c2, "script")), c2.parentNode.removeChild(c2));
    return this;
  }, empty: function() {
    for (var a2, b2 = 0; (a2 = this[b2]) != null; b2++)
      a2.nodeType === 1 && (n.cleanData(oa(a2, false)), a2.textContent = "");
    return this;
  }, clone: function(a2, b2) {
    return a2 = a2 == null ? false : a2, b2 = b2 == null ? a2 : b2, this.map(function() {
      return n.clone(this, a2, b2);
    });
  }, html: function(a2) {
    return J(this, function(a3) {
      var b2 = this[0] || {}, c2 = 0, d2 = this.length;
      if (a3 === void 0 && b2.nodeType === 1)
        return b2.innerHTML;
      if (typeof a3 == "string" && !da.test(a3) && !ia[(ba.exec(a3) || ["", ""])[1].toLowerCase()]) {
        a3 = a3.replace(aa, "<$1></$2>");
        try {
          for (; d2 > c2; c2++)
            b2 = this[c2] || {}, b2.nodeType === 1 && (n.cleanData(oa(b2, false)), b2.innerHTML = a3);
          b2 = 0;
        } catch (e2) {
        }
      }
    ...
    return this.domManip(arguments, function(b2) {
      a2 = this.parentNode, n.cleanData(oa(this)), a2 && a2.replaceChild(b2, this);
    ...
    if (q2 || l2 > 1 && typeof p2 == "string" && !k.checkClone && ea.test(p2))
      return this.each(function(c3) {
        var d3 = m2.eq(c3);
        q2 && (a2[0] = p2.call(this, c3, d3.html())), d3.domManip(a2, b2);
      });
    if (l2 && (c2 = n.buildFragment(a2, this[0].ownerDocument, false, this), d2 = c2.firstChild, c2.childNodes.length === 1 && (c2 = d2), d2)) {
      for (f2 = n.map(oa(c2, "script"), ka), g2 = f2.length; l2 > j2; j2++)
        h2 = c2, j2 !== o2 && (h2 = n.clone(h2, true, true), g2 && n.merge(f2, oa(h2, "script"))), b2.call(this[j2], h2, j2);
      if (g2)
        for (i2 = f2[f2.length - 1].ownerDocument, n.map(f2, la), j2 = 0; g2 > j2; j2++)
          h2 = f2[j2], fa.test(h2.type || "") && !L.access(h2, "globalEval") && n.contains(i2, h2) && (h2.src ? n._evalUrl && n._evalUrl(h2.src) : n.globalEval(h2.textContent.replace(ha, "")));
    }
    return this;
  } }), n.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function(a2, b2) {
    n.fn[a2] = function(a3) {
      for (var c2, d2 = [], e2 = n(a3), g2 = e2.length - 1, h2 = 0; g2 >= h2; h2++)
        c2 = h2 === g2 ? this : this.clone(true), n(e2[h2])[b2](c2), f.apply(d2, c2.get());
  ...
  function ta(a2) {
    var b2 = l, c2 = ra[a2];
    return c2 || (c2 = sa(a2, b2), c2 !== "none" && c2 || (qa = (qa || n("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b2.documentElement), b2 = qa[0].contentDocument, b2.write(), b2.close(), c2 = sa(a2, b2), qa.detach()), ra[a2] = c2), c2;
  }
  var ua = /^margin/, va = new RegExp("^(" + Q + ")(?!px)[a-z%]+$", "i"), wa = function(b2) {
  ...
  function xa(a2, b2, c2) {
    ...
    return c2 = c2 || wa(a2), c2 && (g2 = c2.getPropertyValue(b2) || c2[b2]), c2 && (g2 !== "" || n.contains(a2.ownerDocument, a2) || (g2 = n.style(a2, b2)), va.test(g2) && ua.test(b2) && (d2 = h2.width, e2 = h2.minWidth, f2 = h2.maxWidth, h2.minWidth = h2.maxWidth = h2.width = g2, g2 = c2.width, h2.width = d2, h2.minWidth = e2, h2.maxWidth = f2)), g2 !== void 0 ? g2 + "" : g2;
  }
  function ya(a2, b2) {
    return { get: function() {
  ...
  !function() {
    ...
    if (f2.style) {
      let g3 = function() {
        ...
        b2 = g4.top !== "1%", c2 = g4.width === "4px", d2.removeChild(e2);
      };
      var g2 = g3;
      f2.style.backgroundClip = "content-box", f2.cloneNode(true).style.backgroundClip = "", k.clearCloneStyle = f2.style.backgroundClip === "content-box", e2.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", e2.appendChild(f2);
      a.getComputedStyle && n.extend(k, { pixelPosition: function() {
        return g3(), b2;
      }, boxSizingReliable: function() {
        return c2 == null && g3(), c2;
  ...
  function Fa(a2, b2) {
    if (b2 in a2)
      return b2;
    var c2 = b2[0].toUpperCase() + b2.slice(1), d2 = b2, e2 = Ea.length;
    while (e2--)
      if (b2 = Ea[e2] + c2, b2 in a2)
        return b2;
    return d2;
  }
  ...
  function Ha(a2, b2, c2, d2, e2) {
    for (var f2 = c2 === (d2 ? "border" : "content") ? 4 : b2 === "width" ? 1 : 0, g2 = 0; 4 > f2; f2 += 2)
      c2 === "margin" && (g2 += n.css(a2, c2 + R[f2], true, e2)), d2 ? (c2 === "content" && (g2 -= n.css(a2, "padding" + R[f2], true, e2)), c2 !== "margin" && (g2 -= n.css(a2, "border" + R[f2] + "Width", true, e2))) : (g2 += n.css(a2, "padding" + R[f2], true, e2), c2 !== "padding" && (g2 += n.css(a2, "border" + R[f2] + "Width", true, e2)));
    return g2;
  }
  function Ia(a2, b2, c2) {
    var d2 = true, e2 = b2 === "width" ? a2.offsetWidth : a2.offsetHeight, f2 = wa(a2), g2 = n.css(a2, "boxSizing", false, f2) === "border-box";
    if (0 >= e2 || e2 == null) {
      if (e2 = xa(a2, b2, f2), (0 > e2 || e2 == null) && (e2 = a2.style[b2]), va.test(e2))
        return e2;
      d2 = g2 && (k.boxSizingReliable() || e2 === a2.style[b2]), e2 = parseFloat(e2) || 0;
    }
    return e2 + Ha(a2, b2, c2 || (g2 ? "border" : "content"), d2, f2) + "px";
  }
  function Ja(a2, b2) {
    for (var c2, d2, e2, f2 = [], g2 = 0, h2 = a2.length; h2 > g2; g2++)
      d2 = a2[g2], d2.style && (f2[g2] = L.get(d2, "olddisplay"), c2 = d2.style.display, b2 ? (f2[g2] || c2 !== "none" || (d2.style.display = ""), d2.style.display === "" && S(d2) && (f2[g2] = L.access(d2, "olddisplay", ta(d2.nodeName)))) : (e2 = S(d2), c2 === "none" && e2 || L.set(d2, "olddisplay", e2 ? c2 : n.css(d2, "display"))));
    for (g2 = 0; h2 > g2; g2++)
      d2 = a2[g2], d2.style && (b2 && d2.style.display !== "none" && d2.style.display !== "" || (d2.style.display = b2 ? f2[g2] || "" : "none"));
    return a2;
  }
  n.extend({ cssHooks: { opacity: { get: function(a2, b2) {
    if (b2) {
      var c2 = xa(a2, "opacity");
      return c2 === "" ? "1" : c2;
    }
    ...
    if (a2 && a2.nodeType !== 3 && a2.nodeType !== 8 && a2.style) {
      ...
      return b2 = n.cssProps[h2] || (n.cssProps[h2] = Fa(i2, h2)), g2 = n.cssHooks[b2] || n.cssHooks[h2], c2 === void 0 ? g2 && "get" in g2 && (e2 = g2.get(a2, false, d2)) !== void 0 ? e2 : i2[b2] : (f2 = typeof c2, f2 === "string" && (e2 = Ba.exec(c2)) && (c2 = (e2[1] + 1) * e2[2] + parseFloat(n.css(a2, b2)), f2 = "number"), c2 != null && c2 === c2 && (f2 !== "number" || n.cssNumber[h2] || (c2 += "px"), k.clearCloneStyle || c2 !== "" || b2.indexOf("background") !== 0 || (i2[b2] = "inherit"), g2 && "set" in g2 && (c2 = g2.set(a2, c2, d2)) === void 0 || (i2[b2] = c2)), void 0);
    }
  }, css: function(a2, b2, c2, d2) {
    var e2, f2, g2, h2 = n.camelCase(b2);
    return b2 = n.cssProps[h2] || (n.cssProps[h2] = Fa(a2.style, h2)), g2 = n.cssHooks[b2] || n.cssHooks[h2], g2 && "get" in g2 && (e2 = g2.get(a2, true, c2)), e2 === void 0 && (e2 = xa(a2, b2, d2)), e2 === "normal" && b2 in Da && (e2 = Da[b2]), c2 === "" || c2 ? (f2 = parseFloat(e2), c2 === true || n.isNumeric(f2) ? f2 || 0 : e2) : e2;
  } }), n.each(["height", "width"], function(a2, b2) {
    n.cssHooks[b2] = { get: function(a3, c2, d2) {
      return c2 ? za.test(n.css(a3, "display")) && a3.offsetWidth === 0 ? n.swap(a3, Ca, function() {
        return Ia(a3, b2, d2);
      }) : Ia(a3, b2, d2) : void 0;
    }, set: function(a3, c2, d2) {
      var e2 = d2 && wa(a3);
      return Ga(a3, c2, d2 ? Ha(a3, b2, d2, n.css(a3, "boxSizing", false, e2) === "border-box", e2) : 0);
    } };
  }), n.cssHooks.marginRight = ya(k.reliableMarginRight, function(a2, b2) {
    return b2 ? n.swap(a2, { display: "inline-block" }, xa, [a2, "marginRight"]) : void 0;
    ...
    n.cssHooks[a2 + b2] = { expand: function(c2) {
      for (var d2 = 0, e2 = {}, f2 = typeof c2 == "string" ? c2.split(" ") : [c2]; 4 > d2; d2++)
        e2[a2 + R[d2] + b2] = f2[d2] || f2[d2 - 2] || f2[0];
      return e2;
    } }, ua.test(a2) || (n.cssHooks[a2 + b2].set = Ga);
  }), n.fn.extend({ css: function(a2, b2) {
    return J(this, function(a3, b3, c2) {
      var d2, e2, f2 = {}, g2 = 0;
      if (n.isArray(b3)) {
        for (d2 = wa(a3), e2 = b3.length; e2 > g2; g2++)
  ...
  function Ka(a2, b2, c2, d2, e2) {
    return new Ka.prototype.init(a2, b2, c2, d2, e2);
  }
  n.Tween = Ka, Ka.prototype = { constructor: Ka, init: function(a2, b2, c2, d2, e2, f2) {
    ...
    var a2 = Ka.propHooks[this.prop];
    return a2 && a2.get ? a2.get(this) : Ka.propHooks._default.get(this);
  }, run: function(a2) {
    var b2, c2 = Ka.propHooks[this.prop];
    return this.options.duration ? this.pos = b2 = n.easing[this.easing](a2, this.options.duration * a2, 0, 1, this.options.duration) : this.pos = b2 = a2, this.now = (this.end - this.start) * b2 + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), c2 && c2.set ? c2.set(this) : Ka.propHooks._default.set(this), this;
  } }, Ka.prototype.init.prototype = Ka.prototype, Ka.propHooks = { _default: { get: function(a2) {
    var b2;
    return a2.elem[a2.prop] == null || a2.elem.style && a2.elem.style[a2.prop] != null ? (b2 = n.css(a2.elem, a2.prop, ""), b2 && b2 !== "auto" ? b2 : 0) : a2.elem[a2.prop];
  }, set: function(a2) {
    n.fx.step[a2.prop] ? n.fx.step[a2.prop](a2) : a2.elem.style && (a2.elem.style[n.cssProps[a2.prop]] != null || n.cssHooks[a2.prop]) ? n.style(a2.elem, a2.prop, a2.now + a2.unit) : a2.elem[a2.prop] = a2.now;
  } } }, Ka.propHooks.scrollTop = Ka.propHooks.scrollLeft = { set: function(a2) {
  ...
  var La, Ma, Na = /^(?:toggle|show|hide)$/, Oa = new RegExp("^(?:([+-])=|)(" + Q + ")([a-z%]*)$", "i"), Pa = /queueHooks$/, Qa = [Va], Ra = { "*": [function(a2, b2) {
    var c2 = this.createTween(a2, b2), d2 = c2.cur(), e2 = Oa.exec(b2), f2 = e2 && e2[3] || (n.cssNumber[a2] ? "" : "px"), g2 = (n.cssNumber[a2] || f2 !== "px" && +d2) && Oa.exec(n.css(c2.elem, a2)), h2 = 1, i2 = 20;
    if (g2 && g2[3] !== f2) {
      f2 = f2 || g2[3], e2 = e2 || [], g2 = +d2 || 1;
      do
        h2 = h2 || ".5", g2 /= h2, n.style(c2.elem, a2, g2 + f2);
      while (h2 !== (h2 = c2.cur() / d2) && h2 !== 1 && --i2);
    }
  ...
  function Ta(a2, b2) {
    ...
    for (b2 = b2 ? 1 : 0; 4 > d2; d2 += 2 - b2)
      c2 = R[d2], e2["margin" + c2] = e2["padding" + c2] = a2;
    return b2 && (e2.opacity = e2.width = a2), e2;
  }
  function Ua(a2, b2, c2) {
    for (var d2, e2 = (Ra[b2] || []).concat(Ra["*"]), f2 = 0, g2 = e2.length; g2 > f2; f2++)
  ...
  function Va(a2, b2, c2) {
    ...
    c2.queue || (h2 = n._queueHooks(a2, "fx"), h2.unqueued == null && (h2.unqueued = 0, i2 = h2.empty.fire, h2.empty.fire = function() {
      h2.unqueued || i2();
    }), h2.unqueued++, l2.always(function() {
      l2.always(function() {
        h2.unqueued--, n.queue(a2, "fx").length || h2.empty.fire();
      });
    })), a2.nodeType === 1 && ("height" in b2 || "width" in b2) && (c2.overflow = [o2.overflow, o2.overflowX, o2.overflowY], j2 = n.css(a2, "display"), k2 = j2 === "none" ? L.get(a2, "olddisplay") || ta(a2.nodeName) : j2, k2 === "inline" && n.css(a2, "float") === "none" && (o2.display = "inline-block")), c2.overflow && (o2.overflow = "hidden", l2.always(function() {
      o2.overflow = c2.overflow[0], o2.overflowX = c2.overflow[1], o2.overflowY = c2.overflow[2];
    }));
    for (d2 in b2)
      if (e2 = b2[d2], Na.exec(e2)) {
        if (delete b2[d2], f2 = f2 || e2 === "toggle", e2 === (p2 ? "hide" : "show")) {
          if (e2 !== "show" || !q2 || q2[d2] === void 0)
            continue;
          p2 = true;
        }
        ...
        j2 = void 0;
    if (n.isEmptyObject(m2))
      (j2 === "none" ? ta(a2.nodeName) : j2) === "inline" && (o2.display = j2);
    else {
      ...
      for (d2 in m2)
        g2 = Ua(p2 ? q2[d2] : 0, d2, l2), d2 in q2 || (q2[d2] = g2.start, p2 && (g2.end = g2.start, g2.start = d2 === "width" || d2 === "height" ? 1 : 0));
    }
  }
  function Wa(a2, b2) {
    var c2, d2, e2, f2, g2;
  ...
  function Xa(a2, b2, c2) {
    var d2, e2, f2 = 0, g2 = Qa.length, h2 = n.Deferred().always(function() {
      delete i2.elem;
    }), i2 = function() {
      if (e2)
        return false;
      for (var b3 = La || Sa(), c3 = Math.max(0, j2.startTime + j2.duration - b3), d3 = c3 / j2.duration || 0, f3 = 1 - d3, g3 = 0, i3 = j2.tweens.length; i3 > g3; g3++)
        j2.tweens[g3].run(f3);
      return h2.notifyWith(a2, [j2, f3, c3]), 1 > f3 && i3 ? c3 : (h2.resolveWith(a2, [j2]), false);
    }, j2 = h2.promise({ elem: a2, props: n.extend({}, b2), opts: n.extend(true, { specialEasing: {} }, c2), originalProperties: b2, originalOptions: c2, startTime: La || Sa(), duration: c2.duration, tweens: [], createTween: function(b3, c3) {
    ...
    for (Wa(k2, j2.opts.specialEasing); g2 > f2; f2++)
      if (d2 = Qa[f2].call(j2, a2, k2, j2.opts))
        return d2;
    return n.map(k2, Ua, j2), n.isFunction(j2.opts.start) && j2.opts.start.call(a2, j2), n.fx.timer(n.extend(i2, { elem: a2, anim: j2, queue: j2.opts.queue })), j2.progress(j2.opts.progress).done(j2.opts.done, j2.opts.complete).fail(j2.opts.fail).always(j2.opts.always);
  }
  n.Animation = n.extend(Xa, { tweener: function(a2, b2) {
    n.isFunction(a2) ? (b2 = a2, a2 = ["*"]) : a2 = a2.split(" ");
    for (var c2, d2 = 0, e2 = a2.length; e2 > d2; d2++)
      c2 = a2[d2], Ra[c2] = Ra[c2] || [], Ra[c2].unshift(b2);
  }, prefilter: function(a2, b2) {
    b2 ? Qa.unshift(a2) : Qa.push(a2);
  } }), n.speed = function(a2, b2, c2) {
    var d2 = a2 && typeof a2 == "object" ? n.extend({}, a2) : { complete: c2 || !c2 && b2 || n.isFunction(a2) && a2, duration: a2, easing: c2 && b2 || b2 && !n.isFunction(b2) && b2 };
    return d2.duration = n.fx.off ? 0 : typeof d2.duration == "number" ? d2.duration : d2.duration in n.fx.speeds ? n.fx.speeds[d2.duration] : n.fx.speeds._default, (d2.queue == null || d2.queue === true) && (d2.queue = "fx"), d2.old = d2.complete, d2.complete = function() {
    ...
    return typeof a2 != "string" && (c2 = b2, b2 = a2, a2 = void 0), b2 && a2 !== false && this.queue(a2 || "fx", []), this.each(function() {
      var b3 = true, e2 = a2 != null && a2 + "queueHooks", f2 = n.timers, g2 = L.get(this);
      if (e2)
        g2[e2] && g2[e2].stop && d2(g2[e2]);
      else
        for (e2 in g2)
          g2[e2] && g2[e2].stop && Pa.test(e2) && d2(g2[e2]);
      for (e2 = f2.length; e2--; )
        f2[e2].elem !== this || a2 != null && f2[e2].queue !== a2 || (f2[e2].anim.stop(c2), b3 = false, f2.splice(e2, 1));
    ...
    n.fn[b2] = function(a3, d2, e2) {
      return a3 == null || typeof a3 == "boolean" ? c2.apply(this, arguments) : this.animate(Ta(b2, true), a3, d2, e2);
    };
  }), n.each({ slideDown: Ta("show"), slideUp: Ta("hide"), slideToggle: Ta("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function(a2, b2) {
    n.fn[a2] = function(a3, c2, d2) {
      return this.animate(b2, a3, c2, d2);
    };
  }), n.timers = [], n.fx.tick = function() {
    var a2, b2 = 0, c2 = n.timers;
    for (La = n.now(); b2 < c2.length; b2++)
      a2 = c2[b2], a2() || c2[b2] !== a2 || c2.splice(b2--, 1);
    c2.length || n.fx.stop(), La = void 0;
    ...
    a2.type = "checkbox", k.checkOn = a2.value !== "", k.optSelected = c2.selected, b2.disabled = true, k.optDisabled = !c2.disabled, a2 = l.createElement("input"), a2.value = "t", a2.type = "radio", k.radioValue = a2.value === "t";
  }();
  ...
  n.fn.extend({ attr: function(a2, b2) {
    ...
    if (a2 && f2 !== 3 && f2 !== 8 && f2 !== 2)
      return typeof a2.getAttribute === U ? n.prop(a2, b2, c2) : (f2 === 1 && n.isXMLDoc(a2) || (b2 = b2.toLowerCase(), d2 = n.attrHooks[b2] || (n.expr.match.bool.test(b2) ? Za : Ya)), c2 === void 0 ? d2 && "get" in d2 && (e2 = d2.get(a2, b2)) !== null ? e2 : (e2 = n.find.attr(a2, b2), e2 == null ? void 0 : e2) : c2 !== null ? d2 && "set" in d2 && (e2 = d2.set(a2, c2, b2)) !== void 0 ? e2 : (a2.setAttribute(b2, c2 + ""), c2) : void n.removeAttr(a2, b2));
  }, removeAttr: function(a2, b2) {
    var c2, d2, e2 = 0, f2 = b2 && b2.match(E);
    if (f2 && a2.nodeType === 1)
      while (c2 = f2[e2++])
        d2 = n.propFix[c2] || c2, n.expr.match.bool.test(c2) && (a2[d2] = false), a2.removeAttribute(c2);
  }, attrHooks: { type: { set: function(a2, b2) {
    if (!k.radioValue && b2 === "radio" && n.nodeName(a2, "input")) {
      var c2 = a2.value;
      return a2.setAttribute("type", b2), c2 && (a2.value = c2), b2;
    }
  } } } }), Za = { set: function(a2, b2, c2) {
    return b2 === false ? n.removeAttr(a2, c2) : a2.setAttribute(c2, c2), c2;
  } }, n.each(n.expr.match.bool.source.match(/\w+/g), function(a2, b2) {
    var c2 = $a[b2] || n.find.attr;
    $a[b2] = function(a3, b3, d2) {
      var e2, f2;
      return d2 || (f2 = $a[b3], $a[b3] = e2, e2 = c2(a3, b3, d2) != null ? b3.toLowerCase() : null, $a[b3] = f2), e2;
    };
  });
  ...
  n.fn.extend({ prop: function(a2, b2) {
    ...
    if (a2 && g2 !== 3 && g2 !== 8 && g2 !== 2)
      return f2 = g2 !== 1 || !n.isXMLDoc(a2), f2 && (b2 = n.propFix[b2] || b2, e2 = n.propHooks[b2]), c2 !== void 0 ? e2 && "set" in e2 && (d2 = e2.set(a2, c2, b2)) !== void 0 ? d2 : a2[b2] = c2 : e2 && "get" in e2 && (d2 = e2.get(a2, b2)) !== null ? d2 : a2[b2];
  }, propHooks: { tabIndex: { get: function(a2) {
    return a2.hasAttribute("tabindex") || _a.test(a2.nodeName) || a2.href ? a2.tabIndex : -1;
  ...
  n.fn.extend({ addClass: function(a2) {
    var b2, c2, d2, e2, f2, g2, h2 = typeof a2 == "string" && a2, i2 = 0, j2 = this.length;
    if (n.isFunction(a2))
      return this.each(function(b3) {
        n(this).addClass(a2.call(this, b3, this.className));
      });
    if (h2) {
      for (b2 = (a2 || "").match(E) || []; j2 > i2; i2++)
        if (c2 = this[i2], d2 = c2.nodeType === 1 && (c2.className ? (" " + c2.className + " ").replace(ab, " ") : " ")) {
          f2 = 0;
          while (e2 = b2[f2++])
            d2.indexOf(" " + e2 + " ") < 0 && (d2 += e2 + " ");
          g2 = n.trim(d2), c2.className !== g2 && (c2.className = g2);
        }
    }
    return this;
  }, removeClass: function(a2) {
    var b2, c2, d2, e2, f2, g2, h2 = arguments.length === 0 || typeof a2 == "string" && a2, i2 = 0, j2 = this.length;
    if (n.isFunction(a2))
      return this.each(function(b3) {
    ...
    var c2 = typeof a2;
    return typeof b2 == "boolean" && c2 === "string" ? b2 ? this.addClass(a2) : this.removeClass(a2) : this.each(n.isFunction(a2) ? function(c3) {
      ...
      if (c2 === "string") {
        ...
        (c2 === U || c2 === "boolean") && (this.className && L.set(this, "__className__", this.className), this.className = this.className || a2 === false ? "" : L.get(this, "__className__") || "");
    });
  }, hasClass: function(a2) {
    for (var b2 = " " + a2 + " ", c2 = 0, d2 = this.length; d2 > c2; c2++)
      if (this[c2].nodeType === 1 && (" " + this[c2].className + " ").replace(ab, " ").indexOf(b2) >= 0)
        return true;
    return false;
  } });
  var bb = /\r/g;
  n.fn.extend({ val: function(a2) {
    var b2, c2, d2, e2 = this[0];
    {
      if (arguments.length)
        return d2 = n.isFunction(a2), this.each(function(c3) {
          var e3;
          this.nodeType === 1 && (e3 = d2 ? a2.call(this, c3, n(this).val()) : a2, e3 == null ? e3 = "" : typeof e3 == "number" ? e3 += "" : n.isArray(e3) && (e3 = n.map(e3, function(a3) {
            return a3 == null ? "" : a3 + "";
          })), b2 = n.valHooks[this.type] || n.valHooks[this.nodeName.toLowerCase()], b2 && "set" in b2 && b2.set(this, e3, "value") !== void 0 || (this.value = e3));
        });
      if (e2)
        return b2 = n.valHooks[e2.type] || n.valHooks[e2.nodeName.toLowerCase()], b2 && "get" in b2 && (c2 = b2.get(e2, "value")) !== void 0 ? c2 : (c2 = e2.value, typeof c2 == "string" ? c2.replace(bb, "") : c2 == null ? "" : c2);
    }
  } }), n.extend({ valHooks: { option: { get: function(a2) {
    var b2 = n.find.attr(a2, "value");
    return b2 != null ? b2 : n.trim(n.text(a2));
    ...
    for (var b2, c2, d2 = a2.options, e2 = a2.selectedIndex, f2 = a2.type === "select-one" || 0 > e2, g2 = f2 ? null : [], h2 = f2 ? e2 + 1 : d2.length, i2 = 0 > e2 ? h2 : f2 ? e2 : 0; h2 > i2; i2++)
      if (c2 = d2[i2], !(!c2.selected && i2 !== e2 || (k.optDisabled ? c2.disabled : c2.getAttribute("disabled") !== null) || c2.parentNode.disabled && n.nodeName(c2.parentNode, "optgroup"))) {
        if (b2 = n(c2).val(), f2)
          return b2;
        g2.push(b2);
      }
    ...
    while (g2--)
      d2 = e2[g2], (d2.selected = n.inArray(d2.value, f2) >= 0) && (c2 = true);
  ...
  function rb(a2, b2, c2, d2) {
    ...
    function g2(h2) {
      ...
      return e2[h2] = true, n.each(a2[h2] || [], function(a3, h3) {
        var j2 = h3(b2, c2, d2);
        return typeof j2 != "string" || f2 || e2[j2] ? f2 ? !(i2 = j2) : void 0 : (b2.dataTypes.unshift(j2), g2(j2), false);
      }), i2;
    }
  ...
  function sb(a2, b2) {
    ...
    for (c2 in b2)
      b2[c2] !== void 0 && ((e2[c2] ? a2 : d2 || (d2 = {}))[c2] = b2[c2]);
    return d2 && n.extend(true, a2, d2), a2;
  }
  function tb(a2, b2, c2) {
    var d2, e2, f2, g2, h2 = a2.contents, i2 = a2.dataTypes;
    while (i2[0] === "*")
      i2.shift(), d2 === void 0 && (d2 = a2.mimeType || b2.getResponseHeader("Content-Type"));
    if (d2) {
      for (e2 in h2)
  ...
  n.extend({ active: 0, lastModified: {}, etag: {}, ajaxSettings: { url: ob, type: "GET", isLocal: hb.test(pb[1]), global: true, processData: true, async: true, contentType: "application/x-www-form-urlencoded; charset=UTF-8", accepts: { "*": nb, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" }, contents: { xml: /xml/, html: /html/, json: /json/ }, responseFields: { xml: "responseXML", text: "responseText", json: "responseJSON" }, converters: { "* text": String, "text html": true, "text json": n.parseJSON, "text xml": n.parseXML }, flatOptions: { url: true, context: true } }, ajaxSetup: function(a2, b2) {
    return b2 ? sb(sb(a2, n.ajaxSettings), b2) : sb(n.ajaxSettings, a2);
  }, ajaxPrefilter: qb(lb), ajaxTransport: qb(mb), ajax: function(a2, b2) {
    typeof a2 == "object" && (b2 = a2, a2 = void 0), b2 = b2 || {};
    var c2, d2, e2, f2, g2, h2, i2, j2, k2 = n.ajaxSetup({}, b2), l2 = k2.context || k2, m2 = k2.context && (l2.nodeType || l2.jquery) ? n(l2) : n.event, o2 = n.Deferred(), p2 = n.Callbacks("once memory"), q2 = k2.statusCode || {}, r2 = {}, s2 = {}, t2 = 0, u2 = "canceled", v2 = { readyState: 0, getResponseHeader: function(a3) {
      ...
      if (a3)
        if (2 > t2)
          ...
          v2.always(a3[v2.status]);
      return this;
    }, abort: function(a3) {
      var b3 = a3 || u2;
      return c2 && c2.abort(b3), x2(0, b3), this;
    } };
    if (o2.promise(v2).complete = p2.add, v2.success = v2.done, v2.error = v2.fail, k2.url = ((a2 || k2.url || ob) + "").replace(eb, "").replace(jb, pb[1] + "//"), k2.type = b2.method || b2.type || k2.method || k2.type, k2.dataTypes = n.trim(k2.dataType || "*").toLowerCase().match(E) || [""], k2.crossDomain == null && (h2 = kb.exec(k2.url.toLowerCase()), k2.crossDomain = !(!h2 || h2[1] === pb[1] && h2[2] === pb[2] && (h2[3] || (h2[1] === "http:" ? "80" : "443")) === (pb[3] || (pb[1] === "http:" ? "80" : "443")))), k2.data && k2.processData && typeof k2.data != "string" && (k2.data = n.param(k2.data, k2.traditional)), rb(lb, k2, b2, v2), t2 === 2)
      return v2;
    i2 = n.event && k2.global, i2 && n.active++ === 0 && n.event.trigger("ajaxStart"), k2.type = k2.type.toUpperCase(), k2.hasContent = !ib.test(k2.type), d2 = k2.url, k2.hasContent || (k2.data && (d2 = k2.url += (db.test(d2) ? "&" : "?") + k2.data, delete k2.data), k2.cache === false && (k2.url = fb.test(d2) ? d2.replace(fb, "$1_=" + cb++) : d2 + (db.test(d2) ? "&" : "?") + "_=" + cb++)), k2.ifModified && (n.lastModified[d2] && v2.setRequestHeader("If-Modified-Since", n.lastModified[d2]), n.etag[d2] && v2.setRequestHeader("If-None-Match", n.etag[d2])), (k2.data && k2.hasContent && k2.contentType !== false || b2.contentType) && v2.setRequestHeader("Content-Type", k2.contentType), v2.setRequestHeader("Accept", k2.dataTypes[0] && k2.accepts[k2.dataTypes[0]] ? k2.accepts[k2.dataTypes[0]] + (k2.dataTypes[0] !== "*" ? ", " + nb + "; q=0.01" : "") : k2.accepts["*"]);
    for (j2 in k2.headers)
      v2.setRequestHeader(j2, k2.headers[j2]);
    if (k2.beforeSend && (k2.beforeSend.call(l2, v2, k2) === false || t2 === 2))
      return v2.abort();
    u2 = "abort";
    for (j2 in { success: 1, error: 1, complete: 1 })
      v2[j2](k2[j2]);
    if (c2 = rb(mb, k2, b2, v2)) {
    ...
    function x2(a3, b3, f3, h3) {
      ...
      t2 !== 2 && (t2 = 2, g2 && clearTimeout(g2), c2 = void 0, e2 = h3 || "", v2.readyState = a3 > 0 ? 4 : 0, j3 = a3 >= 200 && 300 > a3 || a3 === 304, f3 && (u3 = tb(k2, v2, f3)), u3 = ub(k2, u3, v2, j3), j3 ? (k2.ifModified && (w2 = v2.getResponseHeader("Last-Modified"), w2 && (n.lastModified[d2] = w2), w2 = v2.getResponseHeader("etag"), w2 && (n.etag[d2] = w2)), a3 === 204 || k2.type === "HEAD" ? x3 = "nocontent" : a3 === 304 ? x3 = "notmodified" : (x3 = u3.state, r3 = u3.data, s3 = u3.error, j3 = !s3)) : (s3 = x3, (a3 || !x3) && (x3 = "error", 0 > a3 && (a3 = 0))), v2.status = a3, v2.statusText = (b3 || x3) + "", j3 ? o2.resolveWith(l2, [r3, x3, v2]) : o2.rejectWith(l2, [v2, x3, s3]), v2.statusCode(q2), q2 = void 0, i2 && m2.trigger(j3 ? "ajaxSuccess" : "ajaxError", [v2, k2, j3 ? r3 : s3]), p2.fireWith(l2, [v2, x3]), i2 && (m2.trigger("ajaxComplete", [v2, k2]), --n.active || n.event.trigger("ajaxStop")));
    }
    return v2;
  ...
  function Ab(a2, b2, c2, d2) {
    ...
    if (n.isArray(b2))
      n.each(b2, function(b3, e3) {
        c2 || wb.test(a2) ? d2(a2, e3) : Ab(a2 + "[" + (typeof e3 == "object" ? b3 : "") + "]", e3, c2, d2);
      });
  ...
  n.param = function(a2, b2) {
    var c2, d2 = [], e2 = function(a3, b3) {
      b3 = n.isFunction(b3) ? b3() : b3 == null ? "" : b3, d2[d2.length] = encodeURIComponent(a3) + "=" + encodeURIComponent(b3);
    };
    if (b2 === void 0 && (b2 = n.ajaxSettings && n.ajaxSettings.traditional), n.isArray(a2) || a2.jquery && !n.isPlainObject(a2))
      n.each(a2, function() {
    ...
    return this.map(function() {
      ...
      var a2 = this.type;
      return this.name && !n(this).is(":disabled") && zb.test(this.nodeName) && !yb.test(a2) && (this.checked || !T.test(a2));
    }).map(function(a2, b2) {
      var c2 = n(this).val();
  ...
  a.attachEvent && a.attachEvent("onunload", function() {
    for (var a2 in Cb)
      Cb[a2]();
  }), k.cors = !!Eb && "withCredentials" in Eb, k.ajax = Eb = !!Eb, n.ajaxTransport(function(a2) {
    var b2;
    return k.cors || Eb && !a2.crossDomain ? { send: function(c2, d2) {
      var e2, f2 = a2.xhr(), g2 = ++Bb;
      if (f2.open(a2.type, a2.url, a2.async, a2.username, a2.password), a2.xhrFields)
        for (e2 in a2.xhrFields)
          f2[e2] = a2.xhrFields[e2];
      ...
      for (e2 in c2)
        f2.setRequestHeader(e2, c2[e2]);
      b2 = function(a3) {
        return function() {
          b2 && (delete Cb[g2], b2 = f2.onload = f2.onerror = null, a3 === "abort" ? f2.abort() : a3 === "error" ? d2(f2.status, f2.statusText) : d2(Db[f2.status] || f2.status, f2.statusText, typeof f2.responseText == "string" ? { text: f2.responseText } : void 0, f2.getAllResponseHeaders()));
        };
      }, f2.onload = b2(), f2.onerror = b2("error"), b2 = Cb[g2] = b2("abort");
      try {
    ...
    a2.cache === void 0 && (a2.cache = false), a2.crossDomain && (a2.type = "GET");
    ...
    if (a2.crossDomain) {
      ...
      return { send: function(d2, e2) {
        b2 = n("<script>").prop({ async: true, charset: a2.scriptCharset, src: a2.url }).on("load error", c2 = function(a3) {
          b2.remove(), c2 = null, a3 && e2(a3.type === "error" ? 404 : 200, a3.type);
  ...
  n.ajaxSetup({ jsonp: "callback", jsonpCallback: function() {
    var a2 = Fb.pop() || n.expando + "_" + cb++;
    return this[a2] = true, a2;
  } }), n.ajaxPrefilter("json jsonp", function(b2, c2, d2) {
    var e2, f2, g2, h2 = b2.jsonp !== false && (Gb.test(b2.url) ? "url" : typeof b2.data == "string" && !(b2.contentType || "").indexOf("application/x-www-form-urlencoded") && Gb.test(b2.data) && "data");
    return h2 || b2.dataTypes[0] === "jsonp" ? (e2 = b2.jsonpCallback = n.isFunction(b2.jsonpCallback) ? b2.jsonpCallback() : b2.jsonpCallback, h2 ? b2[h2] = b2[h2].replace(Gb, "$1" + e2) : b2.jsonp !== false && (b2.url += (db.test(b2.url) ? "&" : "?") + b2.jsonp + "=" + e2), b2.converters["script json"] = function() {
      return g2 || n.error(e2 + " was not called"), g2[0];
    }, b2.dataTypes[0] = "json", f2 = a[e2], a[e2] = function() {
      g2 = arguments;
    }, d2.always(function() {
      a[e2] = f2, b2[e2] && (b2.jsonpCallback = c2.jsonpCallback, Fb.push(e2)), g2 && n.isFunction(f2) && f2(g2[0]), g2 = f2 = void 0;
    }), "script") : void 0;
  }), n.parseHTML = function(a2, b2, c2) {
    if (!a2 || typeof a2 != "string")
      return null;
    typeof b2 == "boolean" && (c2 = b2, b2 = false), b2 = b2 || l;
  ...
  n.fn.load = function(a2, b2, c2) {
    if (typeof a2 != "string" && Hb)
      return Hb.apply(this, arguments);
    var d2, e2, f2, g2 = this, h2 = a2.indexOf(" ");
    return h2 >= 0 && (d2 = n.trim(a2.slice(h2)), a2 = a2.slice(0, h2)), n.isFunction(b2) ? (c2 = b2, b2 = void 0) : b2 && typeof b2 == "object" && (e2 = "POST"), g2.length > 0 && n.ajax({ url: a2, type: e2, dataType: "html", data: b2 }).done(function(a3) {
  ...
  function Jb(a2) {
    return n.isWindow(a2) ? a2 : a2.nodeType === 9 && a2.defaultView;
  }
  n.offset = { setOffset: function(a2, b2, c2) {
    var d2, e2, f2, g2, h2, i2, j2, k2 = n.css(a2, "position"), l2 = n(a2), m2 = {};
    k2 === "static" && (a2.style.position = "relative"), h2 = l2.offset(), f2 = n.css(a2, "top"), i2 = n.css(a2, "left"), j2 = (k2 === "absolute" || k2 === "fixed") && (f2 + i2).indexOf("auto") > -1, j2 ? (d2 = l2.position(), g2 = d2.top, e2 = d2.left) : (g2 = parseFloat(f2) || 0, e2 = parseFloat(i2) || 0), n.isFunction(b2) && (b2 = b2.call(a2, c2, h2)), b2.top != null && (m2.top = b2.top - h2.top + g2), b2.left != null && (m2.left = b2.left - h2.left + e2), "using" in b2 ? b2.using.call(a2, m2) : l2.css(m2);
    ...
    if (f2)
      return b2 = f2.documentElement, n.contains(b2, d2) ? (typeof d2.getBoundingClientRect !== U && (e2 = d2.getBoundingClientRect()), c2 = Jb(f2), { top: e2.top + c2.pageYOffset - b2.clientTop, left: e2.left + c2.pageXOffset - b2.clientLeft }) : e2;
  }, position: function() {
    if (this[0]) {
      var a2, b2, c2 = this[0], d2 = { top: 0, left: 0 };
      return n.css(c2, "position") === "fixed" ? b2 = c2.getBoundingClientRect() : (a2 = this.offsetParent(), b2 = this.offset(), n.nodeName(a2[0], "html") || (d2 = a2.offset()), d2.top += n.css(a2[0], "borderTopWidth", true), d2.left += n.css(a2[0], "borderLeftWidth", true)), { top: b2.top - d2.top - n.css(c2, "marginTop", true), left: b2.left - d2.left - n.css(c2, "marginLeft", true) };
    }
  }, offsetParent: function() {
    return this.map(function() {
      var a2 = this.offsetParent || Ib;
      while (a2 && !n.nodeName(a2, "html") && n.css(a2, "position") === "static")
        a2 = a2.offsetParent;
      return a2 || Ib;
    });
  } }), n.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(b2, c2) {
    var d2 = c2 === "pageYOffset";
    n.fn[b2] = function(e2) {
      return J(this, function(b3, e3, f2) {
        var g2 = Jb(b3);
        return f2 === void 0 ? g2 ? g2[c2] : b3[e3] : void (g2 ? g2.scrollTo(d2 ? a.pageXOffset : f2, d2 ? f2 : a.pageYOffset) : b3[e3] = f2);
      }, b2, e2, arguments.length, null);
    };
  }), n.each(["top", "left"], function(a2, b2) {
    n.cssHooks[b2] = ya(k.pixelPosition, function(a3, c2) {
      return c2 ? (c2 = xa(a3, b2), va.test(c2) ? n(a3).position()[b2] + "px" : c2) : void 0;
    });
    ...
    n.each({ padding: "inner" + a2, content: b2, "": "outer" + a2 }, function(c2, d2) {
      n.fn[d2] = function(d3, e2) {
        var f2 = arguments.length && (c2 || typeof d3 != "boolean"), g2 = c2 || (d3 === true || e2 === true ? "margin" : "border");
        return J(this, function(b3, c3, d4) {
          var e3;
          return n.isWindow(b3) ? b3.document.documentElement["client" + a2] : b3.nodeType === 9 ? (e3 = b3.documentElement, Math.max(b3.body["scroll" + a2], e3["scroll" + a2], b3.body["offset" + a2], e3["offset" + a2], e3["client" + a2])) : d4 === void 0 ? n.css(b3, c3, g2) : n.style(b3, c3, d4, g2);
        }, b2, f2 ? d3 : void 0, f2, null);
      };
    });
  }), n.fn.size = function() {
    return this.length;
  }, n.fn.andSelf = n.fn.addBack, typeof define == "function" && define.amd && define("jquery", [], function() {
    return n;
  });
  var Kb = a.jQuery, Lb = a.$;
  return n.noConflict = function(b2) {
    return a.$ === n && (a.$ = Lb), b2 && a.jQuery === n && (a.jQuery = Kb), n;
